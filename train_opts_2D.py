...
parser.add_argument('--dataset', type=str, choices=['JIGSAWS', 'GTEA', '50SALADS', 'BREAKFAST'], default='JIGSAWS',
...
parser.add_argument('--project_name', type=str, default="2d-networks",
